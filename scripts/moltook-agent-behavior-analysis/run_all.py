...
# Constants
CLEANED_DATA_PATH = str(ROOT_DIR / 'moltbook_final_v4.csv')
RAW_DATA_PATH = str(ROOT_DIR / 'moltbook_temiz.csv')
FINAL_DATA_PATH = str(ROOT_DIR / 'moltbook_temiz_final.csv')
PLOTS_DIR = str(ROOT_DIR / 'assets' / 'plots')
DPI = 300
